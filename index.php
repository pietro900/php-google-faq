 ...
 <html lang="en" dir="ltr">
     ...
     <body>
        ...
        <main>
            <div class="container">
                <?php
                    // creo un div per ogni domanda e stampo le informazioni con il formato richiesto;
                    foreach ($faq as $faqs) { ?>
                        <h2>
                            <?php
                                echo $faqs['domanda'];
                        ...
                        <?php
                            if (is_array($faqs['risposta'])) {
                                for ($i = 0; $i < count($faqs['risposta']); $i++) { ?>
                            <p>
                            <?php
                                $array = $faqs['risposta'];
                                echo $array[$i];
...
<html lang="en" dir="ltr">
    ...
    <body>
        <main>
            <div>
                <?php
                foreach ($faqs as $domanda => $risposta) { ?>
                    <div>
                        <h2>
                            <?php
                                echo $domanda;
